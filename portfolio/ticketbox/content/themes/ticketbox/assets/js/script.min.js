...
function setREVStartSize(t) {
	try {
		var e, a = document.getElementById(t.c).parentNode.offsetWidth;
		if(a = 0 === a || isNaN(a) ? window.innerWidth : a, t.tabw = void 0 === t.tabw ? 0 : parseInt(t.tabw), t.thumbw = void 0 === t.thumbw ? 0 : parseInt(t.thumbw), t.tabh = void 0 === t.tabh ? 0 : parseInt(t.tabh), t.thumbh = void 0 === t.thumbh ? 0 : parseInt(t.thumbh), t.tabhide = void 0 === t.tabhide ? 0 : parseInt(t.tabhide), t.thumbhide = void 0 === t.thumbhide ? 0 : parseInt(t.thumbhide), t.mh = void 0 === t.mh || "" == t.mh ? 0 : t.mh, "fullscreen" === t.layout || "fullscreen" === t.l) e = Math.max(t.mh, window.innerHeight);
		else {
			...
			var r, o = Array(t.rl.length),
				n = 0;
			for(var i in t.tabw = t.tabhide >= a ? 0 : t.tabw, t.thumbw = t.thumbhide >= a ? 0 : t.thumbw, t.tabh = t.tabhide >= a ? 0 : t.tabh, t.thumbh = t.thumbhide >= a ? 0 : t.thumbh, t.rl) o[i] = t.rl[i] < window.innerWidth ? 0 : t.rl[i];
			for(var i in r = o[0], o) r > o[i] && 0 < o[i] && (r = o[i], n = i);
			var h = a > t.gw[n] + t.tabw + t.thumbw ? 1 : (a - (t.tabw + t.thumbw)) / t.gw[n];
			e = t.gh[n] * h + (t.tabh + t.thumbh)
		}
		void 0 === window.rs_init_css && (window.rs_init_css = document.head.appendChild(document.createElement("style"))), document.getElementById(t.c).height = e, window.rs_init_css.innerHTML += "#" + t.c + "_wrapper { height: " + e + "px }"
	} catch(t) {
...
var revapi2, tpj;
jQuery(function() {
	tpj = jQuery, void 0 == tpj("#rev_slider_2_1").revolution ? revslider_showDoubleJqueryError("#rev_slider_2_1") : revapi2 = tpj("#rev_slider_2_1").show().revolution({
...
var htmlDivCss = unescape(".rs-layer.tp-shape.tp-shapewrapper%20%7B%0A%20%20%20%20display%3Anone%3B%0A%7D"),
	htmlDiv = document.getElementById("rs-plugin-settings-inline-css");
...
var htmlDivCss = "	#rev_slider_2_1_wrapper rs-loader.spinner3 div { background-color: #6fbe4a !important; } ",
	htmlDiv = document.getElementById("rs-plugin-settings-inline-css");
if(htmlDiv) htmlDiv.innerHTML = htmlDiv.innerHTML + htmlDivCss;
else {
	var htmlDiv = document.createElement("div");
...
var htmlDivCss = unescape("%23rev_slider_2_1_wrapper%20.uranus.tparrows%20%7B%0A%20%20width%3A60px%3B%0A%20%20height%3A60px%3B%0A%20%20background%3Argba%28255%2C255%2C255%2C0%29%3B%0A%20%7D%0A%20%23rev_slider_2_1_wrapper%20.uranus.tparrows%3Abefore%20%7B%0A%20width%3A60px%3B%0A%20height%3A60px%3B%0A%20line-height%3A60px%3B%0A%20font-size%3A60px%3B%0A%20transition%3Aall%200.3s%3B%0A-webkit-transition%3Aall%200.3s%3B%0A%20%7D%0A%20%0A%20%20%23rev_slider_2_1_wrapper%20.uranus.tparrows%3Ahover%3Abefore%20%7B%0A%20%20%20%20opacity%3A0.75%3B%0A%20%20%7D%0A"),
	htmlDiv = document.getElementById("rs-plugin-settings-inline-css");
if(htmlDiv) htmlDiv.innerHTML = htmlDiv.innerHTML + htmlDivCss;
else {
	var htmlDiv = document.createElement("div");
